...
describe('Service Tests', () => {
    ...
    describe('Creditos Service', () => {
        ...
        beforeEach(async(() => {
            ...
            service = TestBed.get(CreditosService);
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                expect(this.lastConnection.request.url).toEqual('api/creditos/' + 123);
            });
            it('should return Creditos', () => {

                let entity: Creditos;
                service.find(123).subscribe((_entity: Creditos) => {
                    entity = _entity;
                });
